...
@Entity
@Table(name = "extension_delta_moduledependency")
public class Extension_Delta_Module_Dependency {
	@EmbeddedId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Module_Dependency other = (Extension_Delta_Module_Dependency) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
