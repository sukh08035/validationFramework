...
@Entity
@Table(name = "extension_delta_descriptiontype")
public class Extension_Delta_Description_Type {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Description_Type other = (Extension_Delta_Description_Type) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
