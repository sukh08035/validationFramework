...
@Entity
@Table(name = "extension_delta_statedrelationship")
public class Extension_Delta_Stated_Relationship {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Stated_Relationship other = (Extension_Delta_Stated_Relationship) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
