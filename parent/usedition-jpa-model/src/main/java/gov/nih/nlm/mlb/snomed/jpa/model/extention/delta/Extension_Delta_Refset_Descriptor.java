...
@Entity
@Table(name = "extension_delta_refsetdescriptor")
public class Extension_Delta_Refset_Descriptor {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Refset_Descriptor other = (Extension_Delta_Refset_Descriptor) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
