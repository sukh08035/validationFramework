...
@Entity
@Table(name = "extension_delta_attributevalue")
public class Extension_Delta_Attribute_Value {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Attribute_Value other = (Extension_Delta_Attribute_Value) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
