...
@Entity
@Table(name = "extension_delta_textdefinition")
public class Extension_Delta_Text_Definition {
	@EmbeddedId
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Text_Definition other = (Extension_Delta_Text_Definition) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
