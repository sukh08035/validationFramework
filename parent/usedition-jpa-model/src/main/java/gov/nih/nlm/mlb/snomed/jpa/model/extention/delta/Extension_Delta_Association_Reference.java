package gov.nih.nlm.mlb.snomed.jpa.model.extention.delta;
...
@Entity
@Table(name = "extension__delta_associationreference")
public class Extension_Delta_Association_Reference {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		Extension_Delta_Association_Reference other = (Extension_Delta_Association_Reference) obj;
		if (Id == null) {
			if (other.Id != null)
				return false;
